...
mixin _$CheckoutState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<ProductQuantity> productQty) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<ProductQuantity> productQty)? loaded,
...
abstract class _$$LoadedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<ProductQuantity> productQty});
}
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(final List<ProductQuantity> productQty)
      : _productQty = productQty;

  final List<ProductQuantity> _productQty;
  @override
  List<ProductQuantity> get productQty {
    if (_productQty is EqualUnmodifiableListView) return _productQty;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_productQty);
  }

  @override
  String toString() {
    return 'CheckoutState.loaded(productQty: $productQty)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._productQty, _productQty));
  }

  @override
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_productQty));
...
abstract class _Loaded implements CheckoutState {
  const factory _Loaded(final List<ProductQuantity> productQty) = _$LoadedImpl;
